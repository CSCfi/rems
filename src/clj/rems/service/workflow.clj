...
(defn create-workflow! [{:keys [organization handlers licenses forms disable-commands anonymize-handling] :as cmd}]
...
(defn edit-workflow! [{:keys [id organization handlers disable-commands anonymize-handling] :as cmd}]
