...
(defn- theme-variables []
  {:--theme-alert-danger-bgcolor (theme-getx :alert-danger-bgcolor)
   :--theme-alert-danger-bordercolor (theme-getx :alert-danger-bordercolor :alert-danger-color)
   :--theme-alert-danger-color (theme-getx :alert-danger-color)
   :--theme-alert-dark-bgcolor (theme-getx :alert-dark-bgcolor)
   :--theme-alert-dark-bordercolor (theme-getx :alert-dark-bordercolor :alert-dark-color)
   :--theme-alert-dark-color (theme-getx :alert-dark-color)
   :--theme-alert-info-bgcolor (theme-getx :alert-info-bgcolor)
   :--theme-alert-info-bordercolor (theme-getx :alert-info-bordercolor :alert-info-color)
   :--theme-alert-info-color (theme-getx :alert-info-color)
   :--theme-alert-light-bgcolor (theme-getx :alert-light-bgcolor)
   :--theme-alert-light-bordercolor (theme-getx :alert-light-bordercolor :alert-light-color)
   ...
   :--theme-alert-secondary-bordercolor (theme-getx :alert-secondary-bordercolor :alert-secondary-color)
   :--theme-alert-secondary-color (theme-getx :alert-secondary-color)
   :--theme-alert-success-bgcolor (theme-getx :alert-success-bgcolor)
   :--theme-alert-success-bordercolor (theme-getx :alert-success-bordercolor :alert-success-color)
   :--theme-alert-success-color (theme-getx :alert-success-color)
   :--theme-alert-warning-bgcolor (theme-getx :alert-warning-bgcolor)
   :--theme-alert-warning-bordercolor (theme-getx :alert-warning-bordercolor :alert-warning-color)
   ...
   :--theme-collapse-shadow (theme-getx :collapse-shadow :table-shadow)
   ...
   :--theme-footer-bgcolor (theme-getx :footer-bgcolor :table-heading-bgcolor :color3)
   :--theme-footer-color (theme-getx :footer-color :table-heading-color)

   :--theme-header-border (theme-getx :header-border)
   :--theme-header-shadow (theme-getx :header-shadow :table-shadow)

   :--theme-link-color (theme-getx :link-color)
   :--theme-link-hover-color (theme-getx :link-hover-color :color4)
   ...
   :--theme-table-bgcolor (theme-getx :table-bgcolor :color1)
   :--theme-table-border (theme-getx :table-border)
   :--theme-table-heading-bgcolor (theme-getx :table-heading-bgcolor :color3)
