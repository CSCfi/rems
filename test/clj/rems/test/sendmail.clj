    ...
    (with-redefs [catalogue/cached {:localizations (catalogue/load-catalogue-item-localizations!)}]
      (binding [context/*root-path* "localhost:3000"]
        (let [uid "approver"
              ...
              app1 (applications/create-new-draft "test-user" wfid1)
              app2 (applications/create-new-draft "test-user" wfid2)
              app3 (applications/create-new-draft "test-user" wfid2)
              app4 (applications/create-new-draft "test-user" wfid2)
              app5 (applications/create-new-draft "test-user" wfid3)
              app6 (applications/create-new-draft "test-user" wfid4)
