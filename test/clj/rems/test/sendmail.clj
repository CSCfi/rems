...
(deftest test-sending-email
    (conjure/mocking [email/send-mail]
      (binding [context/*user* {"eppn" "test-user" "mail" "invalid-addr"}]
        (let [uid "approver"
              uid2 "reviewer"
          ...
          (testing "Applicant and reviewer should receive an email about the new application"
            ...
            (conjure/verify-first-call-args-for email/send-mail "invalid-addr" "([:t.email/application-sent-subject :t/missing])" "([:t.email/application-sent-msg :t/missing])")
            (conjure/verify-nth-call-args-for 2 email/send-mail "rev-invalid" "([:t.email/review-request-subject :t/missing])" "([:t.email/review-request-msg :t/missing])"))
          (binding [context/*user* {"eppn" "reviewer"}]
            ...
            (testing "Approver gets notified after review round"
              ...
              (conjure/verify-nth-call-args-for 3 email/send-mail "appr-invalid" "([:t.email/approval-request-subject :t/missing])" "([:t.email/approval-request-msg :t/missing])")))
          (binding [context/*user* {"eppn" "approver"}]
            ...
            (testing "Applicant gets notified when application is approved"
              ...
              (conjure/verify-nth-call-args-for 4 email/send-mail "invalid-addr" "([:t.email/status-changed-subject :t/missing])" "([:t.email/status-changed-msg :t/missing])")))
          ...
          (binding [context/*user* {"eppn" "approver"}]
            (testing "Applicant gets notified when application is rejected"
              ...
              (conjure/verify-nth-call-args-for 7 email/send-mail "invalid-addr" "([:t.email/status-changed-subject :t/missing])" "([:t.email/status-changed-msg :t/missing])"))
