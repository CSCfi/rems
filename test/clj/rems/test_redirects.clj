...
(deftest test-redirect-to-new-application
  (testing "redirects to new application page for catalogue item matching the resource ID"
    (let [resid (test-data-functions/create-resource! {:resource-ext-id "urn:one-matching-resource"})
          catid (test-data-functions/create-catalogue-item! {:resource-id resid})
  ...
  (testing "specifying multiple resources"
    (let [wf (test-data-functions/create-workflow! {})
          resid-1 (test-data-functions/create-resource! {:resource-ext-id "urn:multiple1"})
          catid-1 (test-data-functions/create-catalogue-item! {:resource-id resid-1 :workflow-id wf})
          resid-2 (test-data-functions/create-resource! {:resource-ext-id "urn:multiple2"})
          catid-2 (test-data-functions/create-catalogue-item! {:resource-id resid-2 :workflow-id wf})
          resid-3 (test-data-functions/create-resource! {:resource-ext-id "urn:multiple3"})
          catid-3 (test-data-functions/create-catalogue-item! {:resource-id resid-3 :workflow-id nil})] ;; create fresh workflow
  ...
  (testing "fails if more than one catalogue item is found"
    (let [resid (test-data-functions/create-resource! {:resource-ext-id "urn:two-matching-resources"})
          _ (test-data-functions/create-catalogue-item! {:resource-id resid})
          _ (test-data-functions/create-catalogue-item! {:resource-id resid})
  ...
  (testing "redirects to active catalogue item, ignoring disabled items for the same resource ID"
    (let [resid (test-data-functions/create-resource! {:resource-ext-id "urn:enabled-and-disabled-items"})
          old-catid (test-data-functions/create-catalogue-item! {:resource-id resid})
          _ (disable-catalogue-item old-catid)
          new-catid (test-data-functions/create-catalogue-item! {:resource-id resid})
