  ...
  (let [base-events [{:application/id 7
    ...
    (let [events (into
      ...
      (is (= [[]
              []
              [{:to-user "assistant",
                :subject "Application submitted (applicant: 2001/3 \"Application title\")",
                :body "Dear assistant,\n\napplicant has submitted an application (2001/3 \"Application title\"): en title 11, en title 21.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}
               {:to-user "handler",
                :subject "Application submitted (applicant: 2001/3 \"Application title\")",
                :body "Dear handler,\n\napplicant has submitted an application (2001/3 \"Application title\"): en title 11, en title 21.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}]
              ...
              [{:to-user "commenter1",
                :subject "Review requested (handler: 2001/3 \"Application title\")",
                :body "Dear commenter1,\n\nhandler has requested a review on application 2001/3 \"Application title\".\n\nComment: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}
               {:to-user "commenter2",
                :subject "Review requested (handler: 2001/3 \"Application title\")",
              ...
              [{:to-user "applicant",
               ...
               {:to-user "assistant"
                :subject "Application approved (2001/3 \"Application title\")"
                :body "Dear assistant,\n\nhandler has approved the application 2001/3 \"Application title\" from applicant.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}
               {:to-user "member",
                :subject "Application approved (2001/3 \"Application title\")",
                :body "Dear member,\n\nYour application 2001/3 \"Application title\" has been approved.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}
               {:to-user "somebody",
              ...
              [{:to-user "applicant",
               ...
               {:to-user "handler"
                :subject "Application closed (2001/3 \"Application title\")"
                :body "Dear handler,\n\nassistant has closed the application 2001/3 \"Application title\" from applicant.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}
               {:to-user "member",
                :subject "Application closed (2001/3 \"Application title\")",
                :body "Dear member,\n\nYour application 2001/3 \"Application title\" has been closed.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}
               {:to-user "somebody",
      ...
      (let [events (conj base-events
        ...
        (is (= [[]
                ...
                [{:subject "Application rejected (2001/3 \"Application title\")",
                  ...
                  :to-user "applicant"}
                 {:subject "Application rejected (2001/3 \"Application title\")"
                  :body "Dear assistant,\n\nhandler has rejected the application 2001/3 \"Application title\" from applicant.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."
                  :to-user "assistant"}]]
               (events-to-emails events)))))
    (testing "id field can be overrided"
      (with-redefs [rems.config/env (assoc rems.config/env :application-id-column :id)]
        (is (= [[]
                []
                [{:to-user "assistant"
                  :subject "Application submitted (applicant: 7 \"Application title\")"
                  :body "Dear assistant,\n\napplicant has submitted an application (7 \"Application title\"): en title 11, en title 21.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}
                 {:to-user "handler"
                  :subject "Application submitted (applicant: 7 \"Application title\")"
                  :body "Dear handler,\n\napplicant has submitted an application (7 \"Application title\"): en title 11, en title 21.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}]]
    ...
    (testing "application title is optional"
      (is (= [[]
              [{:to-user "assistant",
                ...
                :body "Dear assistant,\n\napplicant has submitted an application (2001/3): en title 11.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}
               {:to-user "handler",
                  :subject "Application submitted (applicant: 2001/3)",
                  :body "Dear handler,\n\napplicant has submitted an application (2001/3): en title 11.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}]]
      ...
      (let [events (conj base-events
        ...
        (is (= [[]
                ...
                [{:to-user "applicant",
                 ...
                 {:to-user "assistant",
                  :subject "Application returned (2001/3 \"Application title\")",
                  :body "Dear assistant,\n\nhandler has returned the application 2001/3 \"Application title\" from applicant.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}]
                [{:to-user "assistant",
                  :subject "Application submitted (applicant: 2001/3 \"Application title\")",
                  :body "Dear assistant,\n\napplicant has submitted an application (2001/3 \"Application title\"): en title 11, en title 21.\n\nView application: http://example.com/#/application/7\n\nPlease don't reply to this automatically generated message."}
                 {:to-user "handler",
