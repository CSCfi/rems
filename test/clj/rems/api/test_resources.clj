...
(deftest resources-api-create-test
  (let [api-key "42"
        ...
        licid-org1 (test-data-functions/create-license! {:organization {:organization/id "organization1"}})
        licid-org2 (test-data-functions/create-license! {:organization {:organization/id "organization2"}})
