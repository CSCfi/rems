...
(deftest organization-enabled-archived-test
  ...
  (with-user "owner"
    (let [org-id1 (test-data-functions/create-organization! {:organization/id "test-org-1"})
          org-id2 (test-data-functions/create-organization! {:organization/id "test-org-2"})]
