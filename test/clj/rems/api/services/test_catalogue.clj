...
(deftest catalogue-item-enabled-archived-test
  (let [owner "owner"
        _org (test-data-functions/create-organization! {})
        form-id (test-data-functions/create-form! {})
        lic-id (test-data-functions/create-license! {})
        res-id (test-data-functions/create-resource! {:resource-ext-id "ext" :license-ids [lic-id]})
        workflow-id (test-data-functions/create-workflow! {})
        item-id (test-data-functions/create-catalogue-item! {:resource-id res-id
                                                   :form-id form-id
                                                   :workflow-id workflow-id})
        item-id2 (test-data-functions/create-catalogue-item! {})
...
(deftest test-edit-catalogue-item
  (let [_org (test-data-functions/create-organization! {})
        item-id (test-data-functions/create-catalogue-item!
                 {:title {:en "Old title"
                          :fi "Vanha nimi"}})
