...
- There is an experimental autosave mode that can be enabled. Applications don't yet automatically get reloaded, should another person be viewing the same application. (`:enable-autosave true`) (#2767)
